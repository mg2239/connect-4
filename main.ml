...
let rec game state = 
  ...
  | Command.Help -> begin 
      print_string ("\nIn Connect Four, the object of the game is "^
                    "to get four of your game pieces in a row either "^
                    "vertically, horizontally, or diagonally. "^
                    "\nYou can also place pieces in a fashion to 
                    block your opponent from getting four in a row." ^
                    "\nTo place a game piece, type: \"go (0-6)\ "^
                    "where the number you input represents the respective 
                    column in the game board. \nIf you need to see this "^ 
                    "message again, type \"help\" into the console.\n\n");
      game state;
    end
